...
const userController = {
    register: async (req, res) => {
        try {
            ...
            <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to the Usama's Blog Website Application.</h2>
            <p>Congratulations!.
            ...
            res.status(200).json({ msg: "Successfully Send Email Kindly check your email" })
    ...
    activateEmail: async (req, res) => {
        try {
            ...
            res.status(200).json({ msg: "ok uer got" })
        } catch (err) {
